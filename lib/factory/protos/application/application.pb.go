...
func (x *ContainerRequestBody) Reset() {
	*x = ContainerRequestBody{}
	mi := &file_application_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ContainerRequestBody) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ContainerRequestBody) ProtoMessage() {}

func (x *ContainerRequestBody) ProtoReflect() protoreflect.Message {
	mi := &file_application_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use ContainerRequestBody.ProtoReflect.Descriptor instead.
func (*ContainerRequestBody) Descriptor() ([]byte, []int) {
	return file_application_proto_rawDescGZIP(), []int{0}
}

func (x *ContainerRequestBody) GetInstanceURL() string {
	if x != nil {
