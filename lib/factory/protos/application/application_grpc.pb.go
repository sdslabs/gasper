...
type ApplicationFactoryClient interface {
	...
	FetchRunningContainers(ctx context.Context, in *UpNodePayload, opts ...grpc.CallOption) (*ContainerList, error)
}
...
func (c *applicationFactoryClient) FetchRunningContainers(ctx context.Context, in *UpNodePayload, opts ...grpc.CallOption) (*ContainerList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ApplicationFactoryServer interface {
	...
	FetchRunningContainers(context.Context, *UpNodePayload) (*ContainerList, error)
...
func (UnimplementedApplicationFactoryServer) FetchRunningContainers(context.Context, *UpNodePayload) (*ContainerList, error) {
...
func _ApplicationFactory_FetchRunningContainers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApplicationFactoryServer).FetchRunningContainers(ctx, req.(*UpNodePayload))
	}
	return interceptor(ctx, in, info, handler)
}
